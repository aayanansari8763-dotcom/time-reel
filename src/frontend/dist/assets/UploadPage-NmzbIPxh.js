import { c as createLucideIcon, r as reactExports, m as useComposedRefs, j as jsxRuntimeExports, n as reactDomExports, R as ReactDOM, g as cn, f as useInternetIdentity, a as useActor, l as useNavigate, u as useQueryClient, B as Button, i as ue, E as ExternalBlob, e as createActor } from "./index-CaylQVRx.js";
import { B as Badge } from "./badge-BdFEhAYx.js";
import { X, I as Input } from "./input-BuVWqQVQ.js";
import { u as useCallbackRef$1, P as Primitive, c as composeEventHandlers, d as dispatchDiscreteCustomEvent, a as useLayoutEffect2, b as createContextScope, e as useDirection, f as useControllableState, g as useId, h as createCollection, i as createSlot, V as Video, L as Label, U as Upload, C as ChevronRight, T as Textarea } from "./textarea-BRBYLjIy.js";
...
function StepDots({ current }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: steps.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: cn(
              "w-8 h-8 rounded-full flex items-center justify-center text-xs font-display font-bold transition-smooth",
              s === current ? "bg-primary text-primary-foreground shadow-[0_0_12px_oklch(var(--primary)/0.5)]" : s < current ? "bg-primary/30 text-primary" : "bg-muted text-muted-foreground"
            ),
            "data-ocid": `upload.step_dot.${s}`,
            children: s < current ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "w-4 h-4" }) : s
          }
        ),
        s < 3 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: cn(
...
function UploadProgressBar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", "data-ocid": "upload.loading_state", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-body", children: "Uploading video…" }),
...
function UploadPage() {
  ...
  const [thumbnailPreviewUrl, setThumbnailPreviewUrl] = reactExports.useState(
    null
  );
  ...
  const handleVideoFile = (f) => {
    ...
    if (f.size > MAX_VIDEO_SIZE) {
      ue.error("Video must be under 100 MB");
      return;
    }
    if (videoPreviewUrl) URL.revokeObjectURL(videoPreviewUrl);
    setVideoFile(f);
    setVideoPreviewUrl(URL.createObjectURL(f));
    setErrors((e) => ({ ...e, video: void 0 }));
  };
  const handleThumbnailFile = (f) => {
    if (!f.type.startsWith("image/")) {
      ue.error("Please select an image file for the thumbnail");
      return;
    }
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 rounded-3xl bg-primary/10 border border-primary/20 flex items-center justify-center shadow-[0_0_32px_oklch(var(--primary)/0.2)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Video, { className: "w-10 h-10 text-primary" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-foreground text-2xl", children: "Sign in to upload" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-2 max-w-[260px] mx-auto leading-relaxed", children: "Create your account to start sharing videos with the Time Reel community" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
          ...
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-24 rounded-full bg-primary/10 border-2 border-primary/40 flex items-center justify-center shadow-[0_0_40px_oklch(var(--primary)/0.3)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "w-12 h-12 text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.div,
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-foreground text-2xl", children: "Your video is live! 🎉" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm mt-2", children: [
                  "“",
                  form.title,
                  "” has been published to Time Reel"
                ] })
              ] }),
    ...
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-foreground text-2xl", children: "Upload Video" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "Share your moment with the world" })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(AnimatePresence, { mode: "wait", children: [
          step === 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-foreground text-lg mb-1", children: "Select your video" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "MP4, MOV, WebM — max 100 MB" })
                ] }),
                !videoFile ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    className: cn(
                      ...
                      isDragging ? "border-primary bg-primary/5 shadow-[0_0_24px_oklch(var(--primary)/0.15)]" : "border-border",
                    ...
                    children: [
                        ...
                        "button",
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "or click to select a file" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs mt-2 opacity-70", children: "Supports: MP4, MOV, WebM, AVI — max 100 MB" })
                            ] })
                          ]
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
                          ...
                          onChange: (e) => {
                            var _a;
                            return ((_a = e.target.files) == null ? void 0 : _a[0]) && handleVideoFile(e.target.files[0]);
                          },
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-2xl overflow-hidden bg-black aspect-[9/16] max-h-[52vh]", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "video",
                      {
                        src: videoPreviewUrl ?? void 0,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/30 rounded-xl px-4 py-3 flex items-center gap-3 border border-border", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg bg-primary/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "w-5 h-5 text-primary" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-sm truncate", children: videoFile.name }),
                ...
                errors.video && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    className: "text-destructive text-sm",
                    "data-ocid": "upload.video_field_error",
                    children: errors.video
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "font-display font-semibold text-foreground text-sm flex items-center gap-2", children: [
                  ...
                  thumbnailPreviewUrl ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-xl overflow-hidden h-24 bg-muted/30", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "img",
                      {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "input",
                          {
                            ...
                            onChange: (e) => {
                              var _a;
                              return ((_a = e.target.files) == null ? void 0 : _a[0]) && handleThumbnailFile(e.target.files[0]);
                            }
                          }
                        )
                      ]
          ...
          step === 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-foreground text-lg mb-1", children: "Add details" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Help people discover your video" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Label,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  ...
                  form.tags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mt-2", children: form.tags.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Badge,
                    {
                      variant: "secondary",
                      ...
                      children: [
                        "#",
                        t,
                        /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-3 h-3 opacity-60" })
                      ]
                    },
                    t
                  )) })
          ...
          step === 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-foreground text-lg mb-1", children: "Preview & publish" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Looks good? Hit Publish!" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl overflow-hidden border border-border bg-card", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aspect-video bg-muted relative overflow-hidden", children: [
                    thumbnailPreviewUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "img",
                      {
                        src: thumbnailPreviewUrl,
                        alt: "Video thumbnail",
                    ...
                    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Video, { className: "w-10 h-10 text-muted-foreground" }) }),
                    form.category && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-2 left-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "font-display text-xs bg-primary/90 text-primary-foreground", children: form.category }) })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground text-base leading-snug", children: form.title || /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground italic", children: "No title" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm font-body", children: "@you" }),
                    form.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/80 text-sm font-body line-clamp-2", children: form.description }),
                    form.tags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 pt-1", children: form.tags.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "span",
                      {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/20 rounded-xl px-4 py-3 flex items-center gap-3 border border-border", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Video, { className: "w-4 h-4 text-primary" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-sm truncate", children: videoFile == null ? void 0 : videoFile.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs", children: videoFile ? `${(videoFile.size / (1024 * 1024)).toFixed(1)} MB` : "" })
                  ] })
                ] }),
